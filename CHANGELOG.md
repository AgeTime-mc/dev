...
Полностью исправлена ошибка с очисткой логов сервера через N промежуток и N количество (про 1.58 напиздеть тут).


## 1.58 (23.05.2025)

Исправлена ошибка с очисткой логов сервера (частично, ночью зальём всё).


## 1.57 (22.05.2025)

Перенесены игровые данные на новый сервер.
Исправлена ошибка с логгированием от системы (ранее было от разработчика, что неправильно).


## 1.56 (20.05.2025) // багодельня ебучая, залить только забыли эххе

Исправлена ошибка ссылки на гайд по привязке (2 сообщения в боте к обычному нужному) ну или как это обозвать чёрт побери.   
Исправлена ссылка в этом злоебучем сообщении бота которая должна была указывать гайд по привязке (ебучий Матвейка, чтоб его + предикт на FAQ, ведь его ещё нету хахахахаххаха).   


## 1.55 (20.05.2025)

Страница админов на сайте была кастрирована.  
Страница правил была кастрирована.
Удалены последние покупки.
Удалены отключённые информационные табло и прочая шняга.


## 1.54 (14.05.2025) // обнова в ядре происходила между 14 - 16 числами, но при этом коммиты мы стёрли, значит между этими числами было то что нам нужно // поменять номера обнова, перефоркать все даты и скорректировать инфу (ПИЗДОС)

Изучены ошибки ядра из-за которых не работали списки связанные с вайт-листом, кэшированными данными и чем-то ещё (уже забыл).  
Короче: из-за этих ошибок юзеры заходили на классик и ломали нам всё, во всём виновато ядро и криворукий разработчик, но там же под 100кк строк кода, ебанат?


## 1.53 (20.05.2025)

Подготовлена почва для переноса данных на другую серверную машину.
Добавлена вечная лицензия на кейсы.
Добавлена поддержка новых анимаций на кейсы.


## 1.52 (19.05.2025)

Изменены ссылки на сайт проекта (частично) в социальных сетях.  
Отключена кнопка покупки в ВК.


## 1.51 (19.05.2025)

Изменено название паблика ВКонтакте.  
Переформулирована информация в описании паблика ВКонтакте.  
Изменено название канала в Telegram.  
Отключены комментарии в канале Telegram.  
Подготовлена почва для новой информационной сферы проекта.  
Осуществлены переносы правил проекта на новый уровень.  
Добавлены новые разделы проекта: жалобы/разбан, команда проекта (moder, media, support, спонсор, тех. админ), баги/идеи, привязка к акку.  
Обновлены версии кодовой базы для скрипта технической поддержки.  
Исправлена ошибка отсутствия места на серверной машине.  
Classic переведён на технические работы.  
Попытка отката с нового метода проксирования данных.  
