...
### Серверная машина.
— Осуществлены бэкапы всех данных режимов для их дальнейшего переноса на новую серверную машину.
...
### Версии.
— Произведена попытка отката обновления связанного с пакетным обработчиком из обновления [1.43](https://github.com/AgeTime-mc/dev/blob/main/CHANGELOG.md#143-04052025), который как показала практика - не был полностью реализован и только нагружал серверную машину и увеличивал пинг. 
### Серверная машина.
...
#### Ядро.
— Изучены ошибки некорректной работоспособности вайт-листа и кэшированием данных пользователей по их [уникальных идентификаторах (UUID)](https://minecraft.wiki/w/UUID).
