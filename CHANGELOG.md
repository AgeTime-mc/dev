...
## 1.50 (14.05.2025) // обнова в ядре происходила между 14 - 16 числами, но при этом коммиты мы стёрли, значит между этими числами было то что нам нужно // поменять номера обнова, перефоркать все даты и скорректировать инфу (ПИЗДОС)
